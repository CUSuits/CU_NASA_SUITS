...
{
    [CustomEditor(typeof(CanvasSpeechInputHandler))]
    public class CanvasSpeechInputHandlerEditor : Editor
    {
        ...
        private SerializedProperty canvasComponentProperty;
        ...
        private void OnEnable()
        {
            ...
            canvasComponentProperty = serializedObject.FindProperty("CanvasComponent");
        }

        public override void OnInspectorGUI()
        {
            serializedObject.Update();
            EditorGUILayout.PropertyField(canvasComponentProperty);
            ...
            {
                var handler = (CanvasSpeechInputHandler)target;
