...
namespace HoloToolkit.Unity
{
    ...
    public class Tagalong : SimpleTagalong
    {
        ...
        // the FOV.
        [Range(0.0f, 2.0f), Tooltip("The minimum horizontal percentage visible before the object starts tagging along.")]
        public float MinimumHorizontalOverlap = 0.0f;
        [Range(0.0f, 2.0f), Tooltip("The target horizontal percentage the Tagalong attempts to achieve.")]
        public float TargetHorizontalOverlap = 0.0f;
        [Range(0.0f, 2.0f), Tooltip("The minimum vertical percentage visible before the object starts tagging along.")]
        public float MinimumVerticalOverlap = 0.0f;
        [Range(0.0f, 2.0f), Tooltip("The target vertical percentage the Tagalong attempts to achieve.")]
        public float TargetVerticalOverlap = 0.0f;
